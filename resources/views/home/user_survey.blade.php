...
@section('title', 'My Surveys -'. $setting->title)
@section('description')
    {{$setting->description}}
@endsection
                    ...
                    <div class="row g-4">
                        <div class="col-md-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-4">
                                <a href="{{route('user_survey_create')}}" type="button" class="btn btn-primary m-2">Add Surveys</a>
                                <table  class="table table-striped table-hover table-secondary">
                                    ...
                                    @foreach ($datalist as $rs)
                                        ...
                                        <td>
                                                <a href="{{route('user_image_create',['survey_id'=>$rs->id])}}"> <button type="button" class="btn btn-primary">
                                        ...
                                        <td>
                                                <a href="{{route('user_survey_edit', ['id'=>$rs->id])}}">Edit</a>
                                            </td>
                                        <td>
                                                <a href="{{route('user_survey_delete', ['id'=> $rs->id])}}" onclick="return confirm('Delete !! are you sure?')" >Delete</a>
                                            </td>
